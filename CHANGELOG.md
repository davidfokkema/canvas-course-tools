...
- A `get_submission()` method to download the submission of a single student.
- Added student id to submission object.

### Changed

- The `get_submissions` method will now download submissions for _all_ students.

## [0.14.2] - 2026-01-22

### Fixed

- Fix course validation error when name and term are missing (restricted)
